...
public class ExecutableMainWindow {
	...
	public ExecutableMainWindow() {
		shell = new Shell();
		shell.setImage(new Image(Display.getCurrent(),"resources/MathWorldIcon.gif"));
		shell.setText("ClusterMaster");
		// shell.setMaximized(true);
		shell.setFont(new Font(Display.getDefault(), "Calibri", 12, SWT.NORMAL));
		shell.setSize(new Point(805, 520));
	...
	private void initialize() {
		...
		createFuzzyGroup();
		closeAllButton = new Button(shell, SWT.NONE);
	...
	private void createHardPartitioningGroup() {
		hardPartitioningGroup = new Group(shell, SWT.NONE);
	...
	private void createDataSetGroup() {
		dataSetGroup = new Group(shell, SWT.NONE);
	...
	private void createHierarchicalGroup() {
		hierarchicalGroup = new Group(shell, SWT.NONE);
	...
	private void createFuzzyGroup() {
		fuzzyGroup = new Group(shell, SWT.NONE);
	...
	public static void main(String[] args) {
		...
		ExecutableMainWindow thisClass = new ExecutableMainWindow();
